...
const WalkthroughScreen = () => {
  ...
  const _renderNextButton = () => {
    return <Text style={styles.button}>{localized('Siguiente')}</Text>
  }

  const _renderSkipButton = () => {
    return <Text style={styles.button}>{localized('Saltar')}</Text>
  }

  const _renderDoneButton = () => {
    return <Text style={styles.button}>{localized('Listo')}</Text>
  }
